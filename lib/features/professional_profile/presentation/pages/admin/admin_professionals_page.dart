...
import 'package:m2health/features/professional_profile/presentation/bloc/admin_professionals_cubit.dart';
import 'package:m2health/features/professional_profile/presentation/pages/admin/admin_professional_detail_page.dart';
...
class _ProfessionalListTabState extends State<_ProfessionalListTab> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => AdminProfessionalsCubit(
