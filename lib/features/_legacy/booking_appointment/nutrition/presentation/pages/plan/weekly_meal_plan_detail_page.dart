...
import 'package:m2health/features/_legacy/booking_appointment/nutrition/presentation/widgets/precision_widgets.dart';
...
class _WeeklyMealPlanDetailPageState extends State<WeeklyMealPlanDetailPage> {
  ...
  Widget build(BuildContext context) {
    final dailyPlan = context
        .read<NutritionPlanCubit>()
        .state
        .nutritionPlan
        ?.weeklyMealPlan[widget.day];
