...
import 'package:m2health/features/_legacy/booking_appointment/homecare_elderly/domain/entities/homecare_task.dart';
import 'package:m2health/features/_legacy/booking_appointment/homecare_elderly/presentation/pages/homecare_appointment_flow_page.dart';
...
class _HouseCleaningPageState extends State<HouseCleaningPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          context.l10n.homecare_house_bedding_cleaning,
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Text(
                  context.l10n.homecare_house_bedding_cleaning_desc,
