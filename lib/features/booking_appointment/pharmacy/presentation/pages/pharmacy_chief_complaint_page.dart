...
class PharmacyChiefComplaintPage extends StatelessWidget {
  final AppointmentEntity appointment;
  const PharmacyChiefComplaintPage({super.key, required this.appointment});

  @override
  Widget build(BuildContext context) {
    final detail = appointment.serviceRequest?.detail;
    final issues = detail is PharmacyGeneralDetail
